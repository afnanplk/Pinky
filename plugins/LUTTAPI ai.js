...
re-coded or modified by shahid-devil
to bring new ai
credit by afnanplk
*/
...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
        if (conf.TALKING_LUTTAPI == 'true' && ((!message.jid.includes('-')) || (message.jid.includes('-') && 
...
Asena.addCommand({ pattern: 'luttapi ?(.*)', desc: fulleva_dsc, fromMe: true,dontAddCommandList: true, usage: '.luttapi on / off' }, (async (message, match) => {
