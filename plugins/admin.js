...
MyPnky.addCommand({pattern: 'ban ?(.*)', fromMe: true, dontAddCommandList: true,plkadmin: true, desc: Lang.BAN_DESC}, (async (message, match) => {  
...
MyPnky.addCommand({pattern: 'add(?: |$)(.*)', fromMe: true, dontAddCommandList: true,plkadmin: true, desc: Lang.ADD_DESC}, (async (message, match) => {  
  if (message.jid.endsWith('@g.us')) {  
  var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
    ...
    if (Config.ADDMSG == 'default') {
     ...
     MyPnky.addCommand({pattern: 'no fake ?(.*)', fromMe: true, dontAddCommandList: true,plkadmin: true, desc: Lang.BAN_DESC}, (async (message, match) => {  
  if (message.jid.endsWith('@g.us')) {  
  var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
MyPnky.addCommand({pattern: 'promote ?(.*)', fromMe: true, dontAddCommandList: true,plkadmin: true, desc: Lang.PROMOTE_DESC}, (async (message, match) => {    
  if (message.jid.endsWith('@g.us')) {  
  var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
MyPnky.addCommand({pattern: 'demote ?(.*)', fromMe: true, desc: Lang.DEMOTE_DESC,plkadmin: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.jid.endsWith('@g.us')) {
  var im = await checkImAdmin(message);
...
MyPnky.addCommand({pattern: 'mute ?(.*)', fromMe: true, dontAddCommandList: true,plkadmin: true, desc: Lang.MUTE_DESC}, (async (message, match) => {    
    if (message.jid.endsWith('@g.us')) {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
MyPnky.addCommand({pattern: 'unmute ?(.*)', fromMe: true, dontAddCommandList: true,plkadmin: true, desc: Lang.UNMUTE_DESC}, (async (message, match) => {    
  if (message.jid.endsWith('@g.us')) { 
  var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
MyPnky.addCommand({pattern: 'invite ?(.*)', fromMe: true, dontAddCommandList: true,plkadmin: true, desc: Lang.INVITE_DESC}, (async (message, match) => {    
   if (message.jid.endsWith('@g.us')) {
  var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
...
MyPnky.addCommand({pattern: 'rename ?(.*)', fromMe: true,plkadmin: true, dontAddCommandList: true, desc: 'change group name'}, (async (message, match) => {
  if (message.jid.endsWith('@g.us')) { 
  var im = await checkImAdmin(message);
