...
if (Config.WORKTYPE == 'private') {
   Shazz.addCommand({ pattern: 'info', fromMe: true,  deleteCommand: false,  desc: Lang.INFO_DESC}, async (message, match) => { 
    ...
    Shazz.addCommand({ pattern: 'info', fromMe: false, desc: Lang.INFO_DESC}, async (message, match) => { 
